...
import { i as isSymbol_1 } from '../_chunks/dep-10024af3.mjs';
import { i as identity_1 } from '../_chunks/dep-6861d388.mjs';
import { t as throttle_1 } from '../_chunks/dep-cede586b.mjs';
...
var useVirtualScroll = function useVirtualScroll(container, params) {
  ...
  watch(function () {
    ...
    if (trHeightList.length === 0) {
      var initHeightList = Array(params.value.data.length).fill(tScroll.value.rowHeight || 47);
